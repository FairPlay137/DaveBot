...
{
    public interface IDaveBotServiceProvider : IServiceProvider, IEnumerable<object>
    {
        T GetService<T>();
    }
    public class DaveBotServiceProvider : IDaveBotServiceProvider
    {
        public class ServiceProviderBuilder
        {
            ...
            public DaveBotServiceProvider Build()
            {
                return new DaveBotServiceProvider(_dict);
            }
            ...
            public ServiceProviderBuilder LoadFrom(Assembly assembly)
            {
                ...
                var services = new Queue<Type>(allTypes
                        .Where(x => x.GetInterfaces().Contains(typeof(IDaveBotService))
        ...
        private DaveBotServiceProvider() { }

        public DaveBotServiceProvider(IDictionary<Type, object> services)
        {
